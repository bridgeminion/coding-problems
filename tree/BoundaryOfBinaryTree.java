 ...
 * The right boundary is similar to the left boundary, except it is the right side of the root's right subtree. Again, the leaf is not
 * part of the right boundary, and the right boundary is empty if the root does not have a right child.
 *
